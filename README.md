...
- [Jetstream](https://jetstream.laravel.com/introduction.html) with [Preact](https://preactjs.com) (lightweight React-compatible alternative) and [teams support](https://jetstream.laravel.com/features/teams.html).
